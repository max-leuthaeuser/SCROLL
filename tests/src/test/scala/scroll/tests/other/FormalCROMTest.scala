...
class FormalCROMTest extends AbstractSCROLLTest {
  ...
  test("Role Groups") {
    ...
    val testrg3 =
      FormalRoleGroup(List(FormalRoleGroup(List("2", FormalRoleGroup(List("3"), 1, 2)), 0, 1), "2"),
                      1,
                      1)
  ...
  test("Constraint Models") {
    ...
    val testcm1 = FormalConstraintModel.forStrings(Map("4" -> List(((1, 3), rgxor))),
                                                   Map("a" -> ((1, 1), (1, 1))),
                                                   List(("a", order)))
    val testcm2 = FormalConstraintModel.forStrings(Map("4" -> List(((1, 1), "2"))),
                                                   Map("a" -> ((1, 1), (1, 1))),
                                                   List.empty)
    val testcm3 =
