...
class PersistentCompartment(db: Instance, factory: TypeFactory) extends Compartment {
  ...
  override def addPlaysRelation[C <: AnyRef : WeakTypeTag, R <: AnyRef : WeakTypeTag](core: C, role: R) {
    require(null != core)
    require(null != role)
  ...
  override def removePlaysRelation[C <: AnyRef : WeakTypeTag, R <: AnyRef : WeakTypeTag](core: C, role: R) {
    require(null != core)
    require(null != role)
    this.plays.removeBinding[C, R](core, role)
  }

  override def transferRole[F <: AnyRef : WeakTypeTag, T <: AnyRef : WeakTypeTag, R <: AnyRef : WeakTypeTag](coreFrom: F, coreTo: T, role: R) {
